            ...
            <div class="login__container">
                ...
                <div class="row justify-content-center">
                    <div class="col-10 col-md-4 col-lg-10">
                        ...
                        <div class="login__reset-password"  style="margin-left: 28px;">
    <p class="forgot-password" style="color: yellow;">Forgot password? <a href="https://indtube.rf.gd/password_reset/reset_pass.php" class="reset-password-link">Reset Password</a></p>
</div>
        ...
        <a href="https://indtube.rf.gd/" class="btn btn-primary" style="background-color: yellow; color: black; position: absolute; top: 20px; left: 50%; transform: translateX(-50%);">Home</a>
